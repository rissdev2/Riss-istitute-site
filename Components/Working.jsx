    ...
    <div className="container mt-5">
        <div className="row work-txt">
            <div className="col-md-12 mb-5">
                <h2><span className='main-color'>We are working overtime</span> to gather talent and get success together as a team by doing:</h2>
            </div>
        </div>
        <div className="row">
            ...
            <div className="col-md-4 text-center crd-txt">
                ...
                <ul className="d-flex justify-content-center ">
                <li><img src="assets/img/whtsap.svg" className="img-fluid me-2" alt="WhatsApp Icon" /></li>
               <li>+92 3471663003</li>
            </ul>
